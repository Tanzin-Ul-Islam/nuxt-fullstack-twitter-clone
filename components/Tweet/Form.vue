    ...
    <div>
        <form @submit.prevent="handleFormSubmit">
            <div class="flex item-center flex-shrink-0 p-4 pb-0">
                ...
                <input type="file" ref="postImageInput" hidden @change="handleImageUpload">
            </div>
            <div class="flex p-2 pl-14">
                <div class="p-2 text-blue-400 rounded-full hover:bg-blue-200 cursor-pointer">
                    <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor" @click="handleImageClick">
                        <g>
                            <path
            ...
            <button type="submit"
                class="bg-blue-500 hover:bg-blue-700 px-3 py-1 rounded text-white font-bold">Tweet</button>
        </form>
